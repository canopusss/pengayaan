...
<body>
    ...
    <section class="is-hero-bar">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
            ...
            <a href="<?php echo e(route('transaksi.create')); ?>" class="button light">Tambah Transaksi</a>
        </div>
    </section>
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $Transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td data-label="id_transaksi"><?php echo e($transaksi->id_transaksi); ?></td>
                                <td data-label="nama_item"><?php echo e($transaksi->barang->nama_produk); ?></td>
                                <td data-label="total_item"><?php echo e($transaksi->total_item); ?></td>
                                <td data-label="total_harga"><?php echo e($transaksi->total_harga); ?></td>
                                <td data-label="status_pembayaran"><?php echo e($transaksi->status_pembayaran); ?></td>
                                <td data-label="Created">
                                    <small class="text-gray-500"
                                        title="Oct 25, 2021"><?php echo e($transaksi->created_at); ?></small>
                                </td>
                                <td>
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                        action="<?php echo e(route('transaksi.destroy', $transaksi->id_transaksi)); ?>"
                                        method="POST">
                                        <a href="<?php echo e(route('nota', $transaksi->id_transaksi)); ?>"
...
</html><?php /**PATH C:\xamppbaru\htdocs\senin\resources\views/dashboard.blade.php ENDPATH**/ ?>