        ...
        <?php echo method_field('PUT'); ?>
          <div class="field">
            <div class="field-body">
              <div class="flex">
                <div class="field">
                  <div class="control icons-left">
                    <input class="input" type="text" placeholder="Nama Barang" name="nama_produk" value="<?php echo e($Barang->nama_produk); ?>">
              ...
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" placeholder="Merk" name="merk" value="<?php echo e($Barang->merk); ?>" >
                  <span class="icon left"><i class="mdi mdi-label-outline"></i></span>
                </div>
              </div>
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="number" placeholder="Harga" name="harga" value="<?php echo e($Barang->harga); ?>">
...
</html><?php /**PATH C:\xamppbaru\htdocs\senin\resources\views/updateformbarang.blade.php ENDPATH**/ ?>